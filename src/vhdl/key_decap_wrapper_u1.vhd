...
entity key_decap_wrapper_u1 is
	port(
		clock                : in  std_logic;
		reset                : in  std_logic;
...
end entity key_decap_wrapper_u1;

architecture RTL of key_decap_wrapper_u1 is
...
begin
	...
	key_decapsulation_inst : entity work.key_decapsulation_u1
		port map(
			clock                => clock,
			reset                => reset,
