...
// B1   F_3 encoding: 2-bit       {00=0, 01=+1, 10=-1}
...
module r3_b1_bridge #(
    ...
    wire u1_done;
    wire [15:0] u1_cc;
    // B1 engine needs 1536-bit (768 coeffs) ar/br; e_u1/ginv_u1 are 1522-bit (761 coeffs).
    // top 7 coefficients (761-767) are zero padding (B1 tree padded to n=768).
    wire [1535:0] ar_b1, br_b1;
    assign ar_b1 = {14'b0, e_u1};      // alt 1522 = e_u1, ust 14 bit = 0
    assign br_b1 = {14'b0, ginv_u1};
    b1_r3_761_serial_0608_1414 u1(
